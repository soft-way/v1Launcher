...
openssl req -new  -subj "/C=CN/ST=BJ/L=BJ/O=IBM/OU=CSL/CN=peer0a" -key tls/peers/peer0/key.pem -out nodecert.csr
...
openssl req -new  -subj "/C=CN/ST=BJ/L=BJ/O=IBM/OU=CSL/CN=peer1a" -key tls/peers/peer1/key.pem -out nodecert.csr
...
openssl req -new  -subj "/C=CN/ST=BJ/L=BJ/O=IBM/OU=CSL/CN=peer2a" -key tls/peers/peer2/key.pem -out nodecert.csr
...
openssl req -new  -subj "/C=CN/ST=BJ/L=BJ/O=IBM/OU=CSL/CN=peer3a" -key tls/peers/peer3/key.pem -out nodecert.csr
